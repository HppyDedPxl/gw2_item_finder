          ...
          if (item.infusions !== void 0) {
            item.infusions.forEach((infusion) => {
              if (infusion === searchId) {
                hits.push({ CharacterName: character.name, EquipmentTabNr: equipmentTab.id, EquipmentTabName: equipmentTab.name, Slot: item.slot });
              }
            });
          }
...
//# sourceMappingURL=/build/routes/index-QF62CBHA.js.map
