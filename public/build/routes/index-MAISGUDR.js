...
function Index() {
  ...
  const [fetchinAccount, setfetchingAccount] = (0, import_react5.useState)(false);
  ...
  function SetApiKey() {
    ...
    newAccount.populateFromApiKey(input_apiKey).then((res) => {
      setAccountInfo(res);
      setfetchingAccount(true);
      accountInfoCookie.serialize(res);
    }).catch((err) => {
      console.log(err);
    });
  }
 ...
 */
//# sourceMappingURL=/build/routes/index-MAISGUDR.js.map
