...
init_react_router_dom();
var [itemCards, setItemCards] = (0, import_react.useState)([]);
function FindItem() {
  console.log("lol");
...
function Index() {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    onClick: FindItem
  }, "Find My Shit!"))), items.map((item) => /* @__PURE__ */ import_react.default.createElement("div", {
    key: item.id
  }, '"Fuck you"')));
}
export {
...
//# sourceMappingURL=/build/routes/index-SILVUKJL.js.map
