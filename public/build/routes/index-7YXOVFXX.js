...
function Index() {
  ...
  const [accountInfo, setAccountInfo2] = (0, import_react5.useState)();
  function SetApiKey() {
    let newAccount = new GW2AccountInfo();
    setFetchingAccount(true);
    newAccount.populateFromApiKey(input_apiKey).then((res) => {
      setAccountInfo2(res);
      localStorage.setItem("gw2AccountInfo", JSON.stringify(accountInfo));
  ...
  let data = localStorage.getItem("gw2AccountInfo");
  if (data !== null) {
    setAccountInfo2(JSON.parse(data));
  }
 ...
 */
//# sourceMappingURL=/build/routes/index-7YXOVFXX.js.map
