...
var GW2API_Call = class {
  ...
  async call() {
    return new Promise((resolve, error) => {
      ...
      myHeaders.append("Authorization", "Bearer 8C902A33-9169-7F44-AC09-131DEE2815835E0A7135-1AF8-4602-BEF7-74AB5ADF9980");
      fetch("https://api.guildwars2.com/v2/characters/", {
        method: "GET",
        headers: myHeaders,
        redirect: "follow"
      }).then((response) => response.text()).then((result) => console.log(result)).catch((error2) => console.log("error", error2));
    });
    let context = this;
  }
...
function Index() {
  ...
  const [input_apiKey, setinput_apiKey] = (0, import_react3.useState)("");
...
//# sourceMappingURL=/build/routes/index-I5S3ZZXQ.js.map
