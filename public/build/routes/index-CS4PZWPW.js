    ...
    this.characters.forEach((character) => {
      character.eqTabs.forEach((equipmentTab) => {
        equipmentTab.equipment.forEach((item) => {
          if (item.id === searchId)
            hits.push({ uuid: GenerateUID(), CharacterName: character.name, EquipmentTabNr: equipmentTab.id, EquipmentTabName: equipmentTab.name, Slot: item.slot });
...
var ItemSearch = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    className: "bg-gray-600 border-solid rounded 1xl mx-1 my-1 h-8 flex flex-row"
  }, /* @__PURE__ */ import_react.default.createElement("img", {
    src: searchItem == null ? void 0 : searchItem.IconUrl,
    className: "h-full px-1 py-1"
  }), /* @__PURE__ */ import_react.default.createElement("div", null, searchItem == null ? void 0 : searchItem.Name)), result.map((r) => /* @__PURE__ */ import_react.default.createElement("div", {
    key: r.uuid
  }))));
};
...
//# sourceMappingURL=/build/routes/index-CS4PZWPW.js.map
