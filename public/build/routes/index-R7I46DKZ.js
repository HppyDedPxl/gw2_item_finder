...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "grid grid-cols-16 grid-flow-col justify-items-auto"
  }, /* @__PURE__ */ React.createElement("input", {
    type: "text",
    name: "item-id",
    id: "item-id",
    className: "focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-2 pr-2 py-1 sm:text-sm border-gray-300 rounded-md col-span-15",
    placeholder: "Item ID [e.g. 76643]"
  }), /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement(QuestionMarkCircleIcon_default, {
...
//# sourceMappingURL=/build/routes/index-R7I46DKZ.js.map
