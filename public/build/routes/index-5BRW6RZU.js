...
var GW2Character = class {
  ...
  SetActivePcESpecializations(pveSpecs) {
    this.eliteSpec = "SET";
  }
};
        ...
        results.forEach((result) => {
          for (let i = 0; i < this.characters.length; i++) {
            if (this.characters[i].name === result.CharacterName) {
              ...
              this.characters[i].PvESpecs = result.CharacterPvESpecs;
...
var ItemSearch = (props) => {
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    className: "bg-gray-800 border-solid  border-2 border-gray-900 rounded 1xl mx-1 my-1 h-8 flex flex-row"
...
//# sourceMappingURL=/build/routes/index-5BRW6RZU.js.map
