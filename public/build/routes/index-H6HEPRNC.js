...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "grid grid-cols-14 grid-flow-col justify-items-auto"
  }, /* @__PURE__ */ React.createElement("input", {
    type: "text",
    name: "item-id",
    id: "item-id",
    className: "focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-2 pr-2 py-1 sm:text-sm border-gray-300 rounded-md col-span-13",
...
//# sourceMappingURL=/build/routes/index-H6HEPRNC.js.map
