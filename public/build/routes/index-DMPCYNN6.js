...
var ItemCard = class extends import_react.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react.default.createElement("div", null, all.map((a) => /* @__PURE__ */ import_react.default.createElement("div", {
      key: a.id
    }, " WAHAAA ")));
  }
};
...
// app/routes/index.tsx
var testCards = [new ItemCard_default({
  "apikey": "AAAAA",
  "itemid": "BBBB"
})];
function Index() {
  const [itemCards, setItemCards] = (0, import_react2.useState)([]);
  const [itemAmount, setItemAmount] = (0, import_react2.useState)(0);
  function FindItem() {
...
//# sourceMappingURL=/build/routes/index-DMPCYNN6.js.map
