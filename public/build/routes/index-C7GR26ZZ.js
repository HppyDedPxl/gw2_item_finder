...
function Index() {
  ...
  function RefreshAccount() {
    ...
    if (accountInfo !== void 0 && accountInfo !== null) {
      ...
      account.populateFromApiKey(accountInfo.ApiKey).then((res) => {
        setAccountInfo(res);
        console.log("Done!");
        localStorage.setItem("gw2AccountInfo", accountInfo.Serialize());
        setFetchingAccount(false);
      }).catch((err) => {
        setFetchingAccount(false);
      });
  ...
  }, accountInfo == null ? void 0 : accountInfo.AccountName), /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "flex w-full text-xs text-gray-400"
  }, "Last Refreshed: ", accountInfo ? ConvertTimespanToTimeString(accountInfo == null ? void 0 : accountInfo.getTimeSinceLastUpdated()) : "invalid", " ago")), /* @__PURE__ */ import_react5.default.createElement("button", {
 ...
 */
//# sourceMappingURL=/build/routes/index-C7GR26ZZ.js.map
