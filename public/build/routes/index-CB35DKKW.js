import {
  ...
  RefreshIcon_default,
  XIcon_default
} from "/build/_shared/chunk-JAR4OMVE.js";
import {
  Link,
  _extends,
  init_extends,
...
var ItemSelect = class extends import_react12.Component {
  constructor() {
    ...
    this.test2PromiseItemOptions = (inputValue) => new Promise((resolve) => {
      console.log(this.props);
      let itemDb = Object.assign(new GW2OfflineItemCache(), this.props.ItemCache);
      let matches = itemDb.GetAllMatching(inputValue);
      console.log("ELL");
      let options2 = [];
      resolve(options2);
    });
  ...
  render() {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(react_select_esm_default, {
      ...
      cacheOptions: true,
      defaultOptions: true,
      loadOptions: this.test2PromiseItemOptions
    }));
  }
};
 ...
 */
//# sourceMappingURL=/build/routes/index-CB35DKKW.js.map
