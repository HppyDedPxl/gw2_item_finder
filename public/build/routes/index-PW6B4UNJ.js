...
function Index() {
  ...
  return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("div", {
    ...
    className: "flex h-auto w-7 ml-1 text-white hover:text-gray-400  bg-blue-600 rounded-md border-1 border-blue-800 border-solid",
    ...
    className: "flex h-auto w-7 ml-1 text-white hover:text-gray-400  bg-red-600 rounded-md border-1 border-red-800 border-solid",
    name: "remove-account-button",
    id: "remove-account-button"
 ...
 */
//# sourceMappingURL=/build/routes/index-PW6B4UNJ.js.map
