...
var GW2API_Call = class {
  ...
  GetCharacterData(characterName) {
    return new Promise((resolve, error) => {
      this.URI = GW2APIEndpoint + " /" + characterName;
      this.call().then((res) => {
...
function Index() {
  ...
  return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("div", {
    ...
    className: "block text-sm font-medium text-white px-1 py-1"
  }, "API Key")), /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "flex flex-row place-items-center justify-items-auto h-8"
  }, /* @__PURE__ */ import_react5.default.createElement("input", {
    type: "password",
    name: "api-key",
    id: "api-key",
    className: "flex focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-2 pr-2 py-1 sm:text-sm border-gray-300 rounded-md",
    placeholder: "API Key",
    onChange: (e) => setinput_apiKey(e.target.value)
  }), /* @__PURE__ */ import_react5.default.createElement("button", {
    name: "confirm-button",
    id: "confirm-button",
    className: "flex pl-2 pr-2 py-1 sm:text-sm border-gray-300 rounded-md bg-green-300 h-full",
    onClick: SetApiKey
  }, " ", fetchingAccount ? /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement(import_react_spinners.RingLoader, null)) : /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, "Fetch Account"), " ")), /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "py-1"
  }), /* @__PURE__ */ import_react5.default.createElement("button", {
    name: "confirm-button",
    id: "confirm-button",
    ...
    onClick: FindItem
  }, "Find My Skritt!"))), itemCards.map((item) => /* @__PURE__ */ import_react5.default.createElement("div", {
    key: item.uid,
    className: "py-2"
 ...
 */
//# sourceMappingURL=/build/routes/index-NULDF6NT.js.map
