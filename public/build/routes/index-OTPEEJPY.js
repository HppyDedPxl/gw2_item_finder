...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    ...
    className: "block text-sm font-medium text-white px-1 py-1"
  }, "Item ID")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("input", {
    type: "text",
    name: "item-id",
    id: "item-id",
    className: "focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-2 pr-2 py-1 sm:text-sm border-gray-300 rounded-md",
    placeholder: "Item ID [e.g. 76643]"
  }), /* @__PURE__ */ React.createElement(QuestionMarkCircleIcon_default, null)))));
}
export {
  Index as default
};
//# sourceMappingURL=/build/routes/index-OTPEEJPY.js.map
