    ...
    return(
        ...
        <div className="bg-gray-800 outline rounded-2xl outline-2 outline-gray-900 overflow-hidden">
            ...
            <ol className="list-disc text-white test-sx text-xs px-5 py-5" type="1">
                <li type="1" className="list-inside">Head over to the <a className="text-gray-500 hover:text-white hover:transition-all transition-all" href="https://account.arena.net/applications" target="_blank">Guild Wars 2 API Key Management</a>.</li>
